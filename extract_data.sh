...
CREATE FOREIGN TABLE transformation.foreign_audit_event(
    id                     BIGSERIAL,
    uuid                   UUID        NOT NULL,
    case_uuid              UUID,
    stage_uuid             UUID,
...
INSERT INTO transformation.audit_event SELECT * FROM transformation.foreign_audit_event WHERE audit_timestamp >= '2022-11-20' limit 1000;
EOF